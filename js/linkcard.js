      ...
      <span class=LinkCard-text>
        <span class=LinkCard-title>${title}</span>
          <span class=LinkCard-meta>
            ...
            </span>${link.match(reg)[0]}
          </span>
        </span>
      <span class=LinkCard-imageCell>
        <img class=LinkCard-image alt=logo src=/img/logo.svg>
      </span>
    </span>
  `;
